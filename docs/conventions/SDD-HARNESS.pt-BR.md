...
🇬🇧 [English version](SDD-HARNESS.md)
...
O checklist de revisão específico de Go vive em `docs/conventions/GO-CODE-REVIEW.pt-BR.md`, neste repositório, como convenção do projeto.
