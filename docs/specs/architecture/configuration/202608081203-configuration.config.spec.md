...
> `DCODE_INSTRUCTIONS_PATH`, `DCODE_INSTRUCTIONS_MAX_BYTES` e `DCODE_INSTRUCTIONS_MAX_DEPTH` **não existem**. Os tetos são literais em `internal/app`; as chaves foram removidas em `202608110900` por nunca terem sido lidas.
