...
4 chaves desta spec foram removidas:

- `DCODE_SUMMARY_MAX_TOKENS`
- `DCODE_SUMMARY_MODEL`
- `DCODE_TOOL_PARALLEL_ENABLED`
- `DCODE_TOOL_TIMEOUT`
...
**Remover a chave não remove o comportamento.** O timeout de ferramenta continua em `120s` e o teto de resumo em `2000`, fixos no código que os usa. O que sai é a promessa de que dá para mudá-lo por configuração, promessa que nunca foi verdadeira.
