...
- Skill que tenta afrouxar segurança é **retida**, com o trecho que casou, e nunca carregada sem alguém responder (RN-7, RN-10).
- Retida aprovada carrega; negada não; **sem ninguém para perguntar, não carrega** — e os três desfechos deixam linha na auditoria (RN-7).
- A linha de índice é filtrada junto com o corpo: corpo inofensivo sob linha ofensiva não passa (RN-7).
- Skill comum **não** é recusada; o filtro é estreito o bastante para conviver com skills reais (RN-7).
