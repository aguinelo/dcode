...
8 chaves desta spec foram removidas:

- `DCODE_INSTRUCTIONS_ENABLED`
- `DCODE_INSTRUCTIONS_MAX_BYTES`
- `DCODE_INSTRUCTIONS_MAX_DEPTH`
- `DCODE_INSTRUCTIONS_PATH`
- `DCODE_REMINDERS_ENABLED`
- `DCODE_REMINDER_KINDS`
- `DCODE_SKILLS_ENABLED`
- `DCODE_SKILLS_MAX_INDEX`
...
**Remover a chave não remove o comportamento.** Os tetos de instrução e o índice de skills continuam nos valores que o código usa. O que sai é a promessa de que dá para mudá-lo por configuração, promessa que nunca foi verdadeira.
