...
- `DCODE_ALLOW_FULL_ACCESS`
- `DCODE_NETWORK_ALLOWLIST`
- `DCODE_REQUIREMENTS_FILE`
- `DCODE_SANDBOX_BIN`
- `DCODE_SANDBOX_PROFILE_DIR`
- `DCODE_SANDBOX_TRACE`
...
**Remover a chave não remove o comportamento.** Os caminhos de binário e de perfil continuam sendo descobertos como já eram. O que sai é a promessa de que dá para mudá-lo por configuração, promessa que nunca foi verdadeira.
