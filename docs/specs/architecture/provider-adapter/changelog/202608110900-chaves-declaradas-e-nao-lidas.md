...
- `DCODE_CONNECT_TIMEOUT`
- `DCODE_MAX_OUTPUT_TOKENS`
- `DCODE_MAX_RETRIES`
- `DCODE_MODEL_WINDOW`
- `DCODE_REQUEST_TIMEOUT`
- `DCODE_RETRY_BASE_DELAY`
- `DCODE_RETRY_MAX_DELAY`
...
**Remover a chave não remove o comportamento.** A política de retry e os timeouts continuam nos valores que o transporte usa. O que sai é a promessa de que dá para mudá-lo por configuração, promessa que nunca foi verdadeira.
