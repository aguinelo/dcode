...
- `DCODE_APPROVAL_TIMEOUT`
- `DCODE_EVENT_RETENTION`
- `DCODE_EVENT_SPILL`
- `DCODE_LOG_FORMAT`
- `DCODE_LOG_LEVEL`
- `DCODE_MAX_SESSIONS`
- `DCODE_MAX_TOOL_OUTPUT`
- `DCODE_TRACE_EVENTS`
...
**Remover a chave não remove o comportamento.** A retenção de evento e o teto de sessões continuam nos valores que o servidor usa. O que sai é a promessa de que dá para mudá-lo por configuração, promessa que nunca foi verdadeira.
