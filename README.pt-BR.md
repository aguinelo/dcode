...
Um harness de codificação agêntico para o terminal, escrito em Go.
...
| Spec do motor de contexto | não iniciada |
| Spec do sandbox | não iniciada |
| Spec do adaptador de provider | não iniciada |
