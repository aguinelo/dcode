...
var loopCommandInvariants = map[string]string{
	...
	"veredito é da **corrida inteira**":            "TestTheVerdictIsAboutTheRunAndNotTheLastSpec",
	"nomeia as specs":                              "TestTheRunNamesTheSpecThatDidNotFinish",
	"quando a fila esvazia":                        "TestAnIdleSessionWithAnEmptyQueueEndsTheRun",
	"primeira spec conta como trabalhada":          "TestARunThatMetNothingStillSaysSo",
	"não pôde ser conferido** conta como pendente": "TestTheVerdictIsAboutTheRunAndNotTheLastSpec",
