...
var toolInvariants = map[string]string{
	...
	// A batch of edits.
	"conferido inteiro antes de qualquer escrita": "TestOneBadEditLeavesEveryFileUntouched",
	"nomeia qual edição falhou":                   "TestAPathOutsideTheWorkspaceStopsTheBatch",
	"aplicam em ordem":                            "TestEditsToOneFileChainInOrder",
	"Todo caminho do lote é declarado":            "TestEveryPathInTheBatchIsDeclared",
	"forma de edição única continua idêntica":     "TestTheSingleEditShapeIsUnchanged",
